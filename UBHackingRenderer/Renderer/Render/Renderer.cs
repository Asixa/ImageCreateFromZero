...
using UBHackingRenderer.Render.Denoise;
using MyLabrary;
using UBHackingRenderer.Render.Mathematics;
using UBHackingRenderer.Render.Scanners;
using static  UBHackingRenderer.Render.Configuration;
using Point = MyLabrary.Point;
using Random = MyLabrary.Random;

namespace UBHackingRenderer.Render
{
    public enum Mode
    {
        NormalMap,
